...
// // Import images from the public directory (no need for file imports)
// const backgroundImage = "/images/7.svg"; // Path relative to /public
// const snsBgImage = "/images/SNS-bg.png"; // Path relative to /public
